              ...
              <div className="flex items-center space-x-2">
                {user && (
                  <button
                    ...
                    className="flex items-center justify-center h-9 w-9 sm:h-10 sm:w-10 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm font-semibold active:scale-95 transition-all duration-200 shadow-md"
                    title="View Profile"
                  >
                ...
                <button
                  ...
                  className="p-2 sm:p-2.5 rounded-full text-[var(--c-text-secondary)] hover:bg-[var(--c-primary-light)] hover:text-[var(--c-primary)] transition-all duration-200 active:scale-95"
