          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                ...
                disabled={syncStatus === 'syncing'}
                className="px-4 py-2 text-sm bg-amber-100 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-700 text-amber-800 dark:text-amber-200 rounded-lg hover:bg-amber-200 dark:hover:bg-amber-900/40 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
                {syncStatus === 'syncing' ? 'Rebuilding...' : 'Rebuild Tracking'}
              </button>
              
              <button
                onClick={handleMarkAllAsSynced}
                disabled={syncStatus === 'syncing'}
                className="px-4 py-2 text-sm bg-blue-100 dark:bg-blue-900/20 border border-blue-300 dark:border-blue-700 text-blue-800 dark:text-blue-200 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/40 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 text-center">
              Use "Rebuild Tracking" to scan calendar for existing events, or "Mark All Synced" to mark all readings as synced
            </p>
          </div>
        </div>
      )}
