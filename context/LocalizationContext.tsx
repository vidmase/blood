...
const translations: Record<Language, Record<string, string>> = {
  ...
  lt: {
    ...
    'filter.toggleAriaLabel': 'Perjungti datos filtro matomumą',
    'filter.show': 'Rodyti',
    'filter.hide': 'Slėpti',
    'reports.title': 'Išplėstinės ataskaitos',
    'reports.summaryTitle': 'Sveikatos suvestinė',
    'reports.stat.avg': 'VIDURKIS',
    'reports.stat.total': 'VISUO',
    'reports.stat.highSystolic': 'Aukščiausias sistolinis',
    'reports.stat.highDiastolic': 'Aukščiausias diastolinis',
    'reports.recordedOn': 'Užregistruota',
    ...
    'enum.general': 'Bendra',
    // Additional UI translations
    'table.noReadingsFound': 'Įrašų nerasta',
    'table.bloodPressureHistory': 'Kraujo spaudimo istorija',
    'table.showingReadings': 'Rodoma {{start}}-{{end}} iš {{total}} įrašų',
    ...
    'table.assessment': 'Įvertinimas',
    'table.notes': 'Pastabos',
    'table.actions': 'Veiksmai',
    'table.edit': 'Redaguoti',
    'table.delete': 'Ištrinti',
    'calendar.header': 'Kalendoriaus vaizdas',
    'calendar.legend': 'Legenda',
    'calendar.hasReadings': 'Yra įrašų',
    'calendar.today': 'Šiandien',
    'pin.title': 'Saugumo patikrinimas',
    'pin.message': 'Įveskite PIN kodą, kad tęstumėte',
    'pin.enterPin': 'Įveskite savo 4 skaitmenų PIN kodą',
    'pin.invalidPin': 'Neteisingas PIN kodas. Bandykite dar kartą.',
    'pin.helpText': 'Įveskite 4 skaitmenų PIN kodą, kad keistumėte įrašus',
    'pin.helpSubtext': 'Tai padeda išvengti atsitiktinių pakeitimų',
    'trends.title': 'Kraujo spaudimo tendencijos',
    'trends.recentPatterns': 'Paskutiniai šablonai ir pokyčiai',
    'trends.systolic': 'Sistolinis',
    'trends.diastolic': 'Diastolinis',
    'trends.pulse': 'Pulsas',
    'trends.upperPressure': 'Viršutinis spaudimas',
    'trends.lowerPressure': 'Apatinis spaudimas',
    'trends.heartRate': 'Širdies ritmas',
    'trends.lastReadings': 'Paskutiniai {{count}} įrašai',
    'trends.average': 'Vid.: {{value}}',
    'trends.bpm': 'dūžiai/min',
    'trends.cards': 'Kortelės',
    'trends.chart': 'Diagrama',
    'trends.compact': 'Kompaktiškas',
    'trends.gauge': 'Matuoklis',
    // Blood Pressure Gauge translations
    'gauge.title': 'Kraujo spaudimo matuokliai',
    'gauge.subtitle': 'Medicinos stiliaus matuoklių vizualizacija',
    'gauge.noDataTitle': 'Matuoklių duomenų nėra',
    'gauge.noDataMessage': 'Pridėkite įrašų, kad matytumėte kraujo spaudimo matuoklius',
    'gauge.reading': 'Įrašas',
    'gauge.systolicPressure': 'Sistolinis spaudimas',
    'gauge.diastolicPressure': 'Diastolinis spaudimas',
    'gauge.heartRate': 'Širdies ritmas',
    'gauge.mmHg': 'mmHg',
    'gauge.bpm': 'dūžiai/min',
    'gauge.normal': 'Normalus',
    'gauge.elevated': 'Pakilęs',
    'gauge.high': 'Aukštas',
    'gauge.of': 'iš',
    // Additional trends translations
    'trends.noDataTitle': 'Tendencijų duomenų nėra',
    'trends.noDataMessage': 'Pridėkite daugiau įrašų, kad matytumėte kraujo spaudimo tendencijas',
    'trends.quickTrends': 'Greitos tendencijos',
    'trends.atGlanceOverview': 'Greitas apžvalga',
    'trends.interactiveChart': 'Interaktyvus grafikas, rodantis jūsų paskutinius {{count}} įrašus',
    'trends.trendAnalysis': 'Kraujo spaudimo tendencijų analizė',
    'trends.currentAvg': 'Dabartinis vid.',
    'trends.optimalBP': 'Optimalus KS',
    'trends.highStage1': 'Aukštas 1 st.',
    'trends.highStage2': 'Aukštas 2 st.',
    // Button translations
    'buttons.addReading': 'Pridėti įrašą',
    'buttons.cameraScan': 'Kameros skanavimas',
    'buttons.aiAnalysis': 'DI analizė',
    'buttons.healthInsights': 'Sveikatos įžvalgos',
    'buttons.analyzing': 'Analizuojama...',
    'buttons.loading': 'Kraunama...',
    'buttons.insights': 'Įžvalgos',
    'buttons.tableView': 'Lentelės vaizdas',
    'buttons.calendarView': 'Kalendoriaus vaizdas',
    'buttons.exportPDF': 'Eksportuoti PDF',
    'buttons.cancel': 'Atšaukti',
    'buttons.runAnalysis': 'Paleisti analizę',
    'buttons.generateInsights': 'Generuoti įžvalgas',
    'buttons.quickActions': 'Greiti veiksmai',
    'buttons.statistics': 'Statistika',
    'buttons.totalReadings': 'Viso įrašų',
    'buttons.thisPeriod': 'Šis laikotarpis',
    // Additional modal text
    'modals.runAnalysisFirst': 'Pirmiausia paleiskite DI analizę, kad sugeneruotumėte įžvalgas.',
    'modals.securityVerification': 'Saugumo patikrinimas',
    'modals.enterPinToEdit': 'Įveskite PIN kodą, kad redaguotumėte įrašą',
    'modals.enterPinToDelete': 'Įveskite PIN kodą, kad ištrintumėte įrašą',
  }
};
